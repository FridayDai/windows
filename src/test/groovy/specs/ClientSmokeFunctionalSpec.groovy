...
////        ACCOUNT_EMAIL = "colin.chen+account4@xplusz.com"
...
//        waitFor(3, 1) { emailInput.displayed }
//
...
//    @Ignore
    def "direct to admin agent email confirmation page successfully"() {
        ...
        waitFor(50, 1) {searchButton.click()}
...
//    @Ignore
    def "add account successfully"() {
        ...
        //TODO: when button click, then check dialog not exist.
...
//        CLIENT_WINDOW = currentWindow
     ...
     */
//    @Ignore
    def "go to Gmail and login successfully again"() {
        browser.setBaseUrl(getGmailUrl())
...
//    @Ignore
    def "check patient and caregiver confirm email received"() {
        ...
        and: "Click search button"
        waitFor(30, 1) {searchButton.click()}
